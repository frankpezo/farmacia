...
class Conexion{
  //2. Declaramos atributos
   ...
   private $atributos=[PDO::ATTR_CASE=>PDO::CASE_LOWER, PDO::ATRR_ERRMODE=>PDO::ERRMODE_EXCEPTION, PDO::ATTR_ORACLE_NULLS=>PDO::NULL_EMPTY_STRING, PDO::ATTR_DEFAULT_FETCH_MODE=> PDO::FETCH_OBJ];
